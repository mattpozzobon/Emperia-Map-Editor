...
protected:
	...
	void BlitMannequinEquipment(int screenx, int screeny, const Tile* tile, bool ephemeral = false, int red = 255, int green = 255, int blue = 255, int alpha = 255);
	void BlitMannequinEquipment(int screenx, int screeny, const Item* item, bool ephemeral = false, int red = 255, int green = 255, int blue = 255, int alpha = 255);
